...
@onready var field_status_panel: Panel = $FieldStatusPanel
@onready var field_status_list: VBoxContainer = $FieldStatusPanel/FieldStatusMargin/FieldStatusVBox/FieldStatusList
@onready var field_status_empty_label: Label = $FieldStatusPanel/FieldStatusMargin/FieldStatusVBox/FieldStatusEmptyLabel
...
var _field_status_rows: Dictionary = {}
